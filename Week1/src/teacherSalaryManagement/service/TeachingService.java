...
import teacherSalaryManagement.entity.teaching.SubjectTeaching;
...
public class TeachingService {
    ...
    public static final String TEACHING_DATA_FILE = "teaching1.dat";
    ...
    public void createTeaching() {
        ...
        for (int i = 0; i < teacherNumber; i++) {
            ...
            Main.fileUtil.writeDataToFile(Main.teachings, TEACHING_DATA_FILE);
        }
    }
    ...
    private Teacher inputTeacherId(int no) {
        ...
        do {
            try {
                ...
                if (findTeacerFromTeaching(teacherId)){
                    System.out.println("Giảng viên vừa nhập đã được phân công, mời nhập lại.");
                    continue;
                }
...
//        }
    ...
    private Teaching findTeaching(int teacherId) {
        ...
        for (int i = 0; i < Main.teachings.length; i++) {
            ...
            if (Main.teachings[i].getTeacher().getId() == teacherId) {
    ...
    private Boolean findTeacerFromTeaching(int id){
        Teaching[] teachings = Main.teachings;
    ...
    public void showTeachings() {
        for (int i = 0; i < Main.teachings.length; i++) {
            ...
            System.out.println(Main.teachings[i].toString());
        }
    }
