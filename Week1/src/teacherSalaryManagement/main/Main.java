...
import teacherSalaryManagement.util.file.FileUtil;
...
public class Main {
    ...
    private static void initializeData() {
        ...
        Main.teachers = DataUtil.isNullOrEmpty(teacherFromFile) ? new Teacher[100] : (Teacher[]) teacherFromFile;
        ...
        Main.teachings = DataUtil.isNullOrEmpty(teachingFromFile) ? new Teaching[100] : (Teaching[]) teachingFromFile;
    }
